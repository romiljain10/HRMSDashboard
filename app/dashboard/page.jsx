...
export default function Dashboard() {
  ...
  return (
    <AppLayout>
      <Header title="HR Dashboard" subtitle={`${location}  |  Apr 27 – May 3, 2026`} locations={locations} />
      <main className="main-content" style={{ flex: 1, overflowY: "auto", padding: "16px 20px", background: "#f0f4f8" }}>
        ...
        {/* Property card — click through to see all employees at this hotel */}
        <Link href="/employees" style={{ textDecoration: "none", display: "block", marginBottom: 14 }}>
          <div style={{
            background: "linear-gradient(135deg, #0f2044 0%, #1e3a5f 100%)", borderRadius: 8, padding: "16px 18px",
            display: "flex", alignItems: "center", gap: 14, cursor: "pointer",
          }}>
            <div style={{ background: "rgba(255,255,255,0.12)", borderRadius: 8, padding: 10, flexShrink: 0 }}>
              <Building2 size={22} color="white" />
            </div>
            <div style={{ flex: 1, minWidth: 0 }}>
              <div style={{ color: "white", fontWeight: 700, fontSize: 15 }}>{location === "All Locations" ? PROPERTY.name : location}</div>
              <div style={{ color: "#94a3b8", fontSize: 11, display: "flex", alignItems: "center", gap: 4, marginTop: 2, flexWrap: "wrap" }}>
                {location === "All Locations" ? (
                  <>
                    <MapPin size={10} /> {PROPERTY.address}
                    <span style={{ margin: "0 4px" }}>•</span>
                    <BedDouble size={10} /> {PROPERTY.rooms} rooms
                    <span style={{ margin: "0 4px" }}>•</span>
                  </>
                ) : (
                  <>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 4, color: "#60a5fa", fontSize: 12, fontWeight: 600, flexShrink: 0 }}>
