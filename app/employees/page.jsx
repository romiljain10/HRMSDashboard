...
export default function EmployeesPage() {
  ...
  const filtered = employees
    .filter(e => {
      ...
      return (e.name.toLowerCase().includes(s) || e.title.toLowerCase().includes(s) || e.employeeNumber.toLowerCase().includes(s))
  ...
  return (
    <AppLayout>
      <Header title="Employee Directory" subtitle="La Bella Vista Hotel  |  Apr 27 – May 3, 2026" />
