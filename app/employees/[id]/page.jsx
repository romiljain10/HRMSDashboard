        ...
        <div className="grid-2col">
          ...
          <div style={{ background:"white",borderRadius:8,border:"1px solid #e2e8f0",padding:20 }}>
            <div style={{ display:"flex",alignItems:"center",gap:14,marginBottom:16 }}>
              <Avatar id={emp.id} name={emp.name} size={52} fontSize={18} />
              <div>
          ...
          {/* Payroll Summary */}
          <div style={{ background:"white",borderRadius:8,border:"1px solid #e2e8f0",padding:20 }}>
            <div style={{ fontWeight:700,fontSize:13,color:"#0f172a",marginBottom:12 }}>Weekly Payroll Summary — {formatDateRangeLabel(start, end)}</div>
